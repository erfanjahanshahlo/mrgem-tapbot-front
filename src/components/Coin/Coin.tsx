...
const Coin = ({}: Props) => {
  ...
  return (
    <motion.div
      ...
      className="w-5/6 min-w-[66%] h-auto aspect-square mx-auto my-5 relative max-w-[80%] shadow-[inset_2px_2px_17px_0_var(--tw-shadow-color)]  shadow-black-100 rounded-full   ">
