    ...
    <div className="w-full h-full flex flex-col justify-between items-center gap-5">
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="w-full space-y-1.5">
          <div className="grid grid-cols-4 p-2  bg-white/10 backdrop-blur-3xl rounded-2xl gap-2 transition-colors duration-500">
          ...
          <div className="grid grid-cols-4 p-2  pb-5 bg-white/10 backdrop-blur-3xl rounded-2xl gap-2 transition-colors duration-500">
            <img src={ClashOfClansLogo} className="w-full rounded-md" />
            <div className="col-span-3 text-sm flex flex-col justify-start items-start gap-2">
      ...
      <div className="w-full h-fit grid grid-cols-6 gap-1">
        <button className="bg-primary-100 text-white/90 rounded-xl  w-full h-full animate-pulse col-span-5  capitalize flex justify-center items-center gap-1">
          Invite friends
          <UserPlus2 className="size-5" />
        </button>
        <button className="bg-primary-100 text-white/90 rounded-xl  w-full   capitalize aspect-square flex justify-center items-center gap-1">
          <Copy />
        </button>
      </div>
    </div>
