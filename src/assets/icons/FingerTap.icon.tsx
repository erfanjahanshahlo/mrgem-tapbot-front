    ...
    <svg
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          ...
          <g>
            {" "}
            <path d="M175.365,0c-4.564,0-8.264,3.699-8.264,8.264V41.32c0,4.565,3.7,8.264,8.264,8.264c4.564,0,8.264-3.699,8.264-8.264V8.264 C183.629,3.699,179.929,0,175.365,0z" />{" "}
          </g>{" "}
        </g>{" "}
        <g>
          {" "}
          <g>
            {" "}
            <path d="M134.46,59.076L111.087,35.7c-3.227-3.226-8.46-3.226-11.686,0c-3.227,3.229-3.227,8.46,0,11.688l23.374,23.375 c1.613,1.614,3.729,2.421,5.843,2.421c2.115,0,4.23-0.807,5.843-2.42C137.688,67.535,137.688,62.304,134.46,59.076z" />{" "}
          </g>{" "}
        </g>{" "}
        <g>
          {" "}
          <g>
            {" "}
            <path d="M251.331,35.701c-3.227-3.226-8.46-3.226-11.686,0l-23.374,23.375c-3.227,3.228-3.227,8.46,0,11.687 c1.613,1.613,3.728,2.42,5.843,2.42c2.114,0,4.23-0.807,5.843-2.42l23.374-23.375C254.558,44.161,254.558,38.929,251.331,35.701z" />{" "}
          </g>{" "}
        </g>{" "}
        <g>
          {" "}
