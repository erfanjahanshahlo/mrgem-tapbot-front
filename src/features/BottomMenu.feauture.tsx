...
const BottomMenu = ({}: Props) => {
  return (
    <div className="w-[calc(100%-40px)] h-[70px] bg-card border border-cardBorder border-b-transparent  max-w-md fixed bottom-0 rounded-xl  flex justify-between px-6 py-2 items-center gap-4 left-1/2 -translate-x-1/2 backdrop-blur-3xl">
      <Link
        to="/"
